...
#define   PDB_SEQRES_SERNUM       8
#define   PDB_SEQRES_SERNUM_LEN       2

/*   12             Character      chainID       Chain identifier */
#define   PDB_SEQRES_CHAINID          11
#define   PDB_SEQRES_CHAINID_LEN       1
/*   14 - 17        Integer         numRes       Number of residues in the chain */
#define   PDB_SEQRES_CHAIN_NUMRES          13
#define   PDB_SEQRES_CHAIN_NUMRES_LEN       4

/*20 - 22        Residue name    resName       Residue name*/
#define   PDB_SEQRES_FIRST_FIELD    19
#define   PDB_SEQRES_MAX_RES       13
#define   PDB_SEQRES_RES_NAME_LEN       3
